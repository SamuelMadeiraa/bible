    ...
    <section className="chamada" id="baixar">
      <div className="container">
        <div className="chamada-caixa revelar">
          ...
          <a className="btn btn-primario btn-g" href={LINK_DOWNLOAD}><Download size={20} />Baixar o BibleLyrics</a>
          ...
          <div className="chamada-celular">
            ...
            <small>No BibleLyrics, clique em <b>📱 Celular</b> e escaneie o QR code — o app instala na tela inicial do Android e do iPhone.</small>
          </div>
        </div>
      </div>
    </section>
